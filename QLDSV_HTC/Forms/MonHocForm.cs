...
namespace QLDSV_HTC.Forms
{
    public partial class MonHocForm : DevExpress.XtraEditors.XtraForm
    {
        ...
        private bool ValidateForm()
        {
            ...
            if (Convert.ToInt32(txtSoTietLT.EditValue.ToString() + Convert.ToInt32(txtSoTietTH.EditValue.ToString())) % 15 != 0)
            {
                XtraMessageBox.Show("Tổng số tiết lý thuyết và thực hành phải là bội số của 15!", "Lỗi",
                    MessageBoxButtons.OK, MessageBoxIcon.Error);
                return false;
            }
