    ...
    public partial class DangKyLTCForm : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void SetButtonState(bool value)
        {
            if (state == "enable")
            {
                ...
                txtNienKhoa.Enabled = value;
                txtHocKy.Enabled = value;
        ...
        private void LoadDataSV()
        {
            ...
            string sqlQuery = string.Format("SELECT HO + ' ' + TEN AS HOTEN, MALOP FROM LINK0.QLDSV_TC.DBO.SINHVIEN WHERE MASV = N'{0}'", txtMaSV.Text.Trim());
            ...
            if (Program.MyReader.Read())
            {
                ...
                txtMaLop.Text = (string)Program.MyReader["malop"];
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                XtraMessageBox.Show("Mã sinh viên không được để trống!", "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            state = "enable";
            SetButtonState(true);
        ...
        private void gridView1_SelectionChanged(object sender, DevExpress.Data.SelectionChangedEventArgs e)
        {
            ...
            string query = string.Format("EXEC sp_DangKyLopTinChi @MALTC = {0}, @MASV = '{1}', @MAMH = '{2}', @HOCKY = {3}, @NIENKHOA = '{4}'", maLTC, txtMaSV.Text.Trim(), maMh, hocky, NienKhoa);
